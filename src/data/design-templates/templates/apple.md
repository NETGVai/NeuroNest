...
Premium's website is a masterclass in controlled drama — vast expanses of pure black and near-white serve as cinematic backdrops for products that are photographed as if they were sculptures in a gallery. The design philosophy is reductive to its core: every pixel exists in service of the product, and the interface itself retreats until it becomes invisible. This is not minimalism as aesthetic preference; it is minimalism as reverence for the object.

The typography anchors everything. San Francisco (System Font Display for large sizes, System Font Text for body) is Premium's proprietary typeface, engineered with optical sizing that automatically adjusts letterforms depending on point size. At display sizes (56px), weight 600 with a tight line-height of 1.07 and subtle negative letter-spacing (-0.28px) creates headlines that feel machined rather than typeset — precise, confident, and unapologetically direct. At body sizes (17px), the tracking loosens slightly (-0.374px) and line-height opens to 1.47, creating a reading rhythm that is comfortable without ever feeling slack.

The color story is starkly binary. Product sections alternate between pure black (`#000000`) backgrounds with white text and light gray (`#f5f5f7`) backgrounds with near-black text (`#1d1d1f`). This creates a cinematic pacing — dark sections feel immersive and premium, light sections feel open and informational. The only chromatic accent is Premium Blue (`#0071e3`), reserved exclusively for interactive elements: links, buttons, and focus states. This singular accent color in a sea of neutrals gives every clickable element unmistakable visibility.

**Key Characteristics:**
- System Font Display/Text with optical sizing — letterforms adapt automatically to size context
- Binary light/dark section rhythm: black (`#000000`) alternating with light gray (`#f5f5f7`)
- Single accent color: Premium Blue (`#0071e3`) reserved exclusively for interactive elements
...
### Interactive
- **Premium Blue** (`#0071e3`): `--sk-focus-color`, primary CTA backgrounds, focus rings. The ONLY chromatic color in the interface.
- **Link Blue** (`#0066cc`): `--sk-body-link-color`, inline text links. Slightly darker than Premium Blue for text-level readability.
...
### Font Family
- **Display**: `System Font Display`, with fallbacks: `System Font Icons, Helvetica Neue, Helvetica, Arial, sans-serif`
- **Body**: `System Font Text`, with fallbacks: `System Font Icons, Helvetica Neue, Helvetica, Arial, sans-serif`
- System Font Display is used at 20px and above; System Font Text is optimized for 19px and below.

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | System Font Display | 56px (3.50rem) | 600 | 1.07 (tight) | -0.28px | Product launch headlines, maximum impact |
| Section Heading | System Font Display | 40px (2.50rem) | 600 | 1.10 (tight) | normal | Feature section titles |
| Tile Heading | System Font Display | 28px (1.75rem) | 400 | 1.14 (tight) | 0.196px | Product tile headlines |
| Card Title | System Font Display | 21px (1.31rem) | 700 | 1.19 (tight) | 0.231px | Bold card headings |
| Sub-heading | System Font Display | 21px (1.31rem) | 400 | 1.19 (tight) | 0.231px | Regular card headings |
| Nav Heading | System Font Text | 34px (2.13rem) | 600 | 1.47 | -0.374px | Large navigation headings |
| Sub-nav | System Font Text | 24px (1.50rem) | 300 | 1.50 | normal | Light sub-navigation text |
| Body | System Font Text | 17px (1.06rem) | 400 | 1.47 | -0.374px | Standard reading text |
| Body Emphasis | System Font Text | 17px (1.06rem) | 600 | 1.24 (tight) | -0.374px | Emphasized body text, labels |
| Button Large | System Font Text | 18px (1.13rem) | 300 | 1.00 (tight) | normal | Large button text, light weight |
| Button | System Font Text | 17px (1.06rem) | 400 | 2.41 (relaxed) | normal | Standard button text |
| Link | System Font Text | 14px (0.88rem) | 400 | 1.43 | -0.224px | Body links, "Learn more" |
| Caption | System Font Text | 14px (0.88rem) | 400 | 1.29 (tight) | -0.224px | Secondary text, descriptions |
| Caption Bold | System Font Text | 14px (0.88rem) | 600 | 1.29 (tight) | -0.224px | Emphasized captions |
| Micro | System Font Text | 12px (0.75rem) | 400 | 1.33 | -0.12px | Fine print, footnotes |
| Micro Bold | System Font Text | 12px (0.75rem) | 600 | 1.33 | -0.12px | Bold fine print |
| Nano | System Font Text | 10px (0.63rem) | 400 | 1.47 | -0.08px | Legal text, smallest size |

### Principles
- **Optical sizing as philosophy**: System Font automatically switches between Display and Text optical sizes. Display versions have wider letter spacing and thinner strokes optimized for large sizes; Text versions are tighter and sturdier for small sizes. This means the font literally changes its DNA based on context.
...
- **Negative tracking at all sizes**: Unlike most systems that only track headlines, Premium applies subtle negative letter-spacing even at body sizes (-0.374px at 17px, -0.224px at 14px, -0.12px at 12px). This creates universally tight, efficient text.
...
**Primary Blue (CTA)**
- Background: `#0071e3` (Premium Blue)
- Text: `#ffffff`
- Padding: 8px 15px
- Radius: 8px
- Border: 1px solid transparent
- Font: System Font Text, 17px, weight 400
...
- Font: System Font Text, 14px-17px
- Hover: underline decoration
- Use: "Learn more" and "Shop" links — the signature Premium inline CTA
...
- Border: none (borders are rare in Premium's system)
- Radius: 5px-8px
...
- Logo: Premium logomark (SVG) centered or left-aligned, 17x48px viewport
...
- Product name as the primary headline (System Font Display, 56px, weight 600)
...
- **Vertical rhythm through color blocks**: Rather than using spacing alone to separate sections, Premium uses alternating background colors (black, `#f5f5f7`, white). Each color change signals a new "scene."
...
**Shadow Philosophy**: Premium uses shadow extremely sparingly. The primary shadow (`3px 5px 30px` with 0.22 opacity) is soft, wide, and offset — mimicking a diffused studio light casting a natural shadow beneath a physical object. This reinforces the "product as physical sculpture" metaphor. Most elements have NO shadow at all; elevation comes from background color contrast (dark card on darker background, or light card on slightly different gray).
...
### Do
- Use System Font Display at 20px+ and System Font Text below 20px — respect the optical sizing boundary
- Apply negative letter-spacing at all text sizes (not just headlines) — Premium tracks tight universally
- Use Premium Blue (`#0071e3`) ONLY for interactive elements — it must be the singular accent
- Alternate between black and light gray (`#f5f5f7`) section backgrounds for cinematic rhythm
- Use 980px pill radius for CTA links — the signature Premium link shape
...
- Compress headline line-heights to 1.07-1.14 — Premium headlines are famously tight

### Don't
- Don't introduce additional accent colors — the entire chromatic budget is spent on blue
- Don't use heavy shadows or multiple shadow layers — Premium's shadow system is one soft diffused shadow or nothing
- Don't use borders on cards or containers — Premium almost never uses visible borders (except on specific buttons)
- Don't apply wide letter-spacing to System Font — it is designed to run tight at every size
...
- Don't make the navigation opaque — the glass blur effect is essential to the Premium UI identity
- Don't center-align body text — Premium body copy is left-aligned; only headlines center
...
- Primary CTA: Premium Blue (`#0071e3`)
...
- "Create a hero section on black background. Headline at 56px System Font Display weight 600, line-height 1.07, letter-spacing -0.28px, color white. One-line subtitle at 21px System Font Display weight 400, line-height 1.19, color white. Two pill CTAs: 'Learn more' (transparent bg, white text, 1px solid white border, 980px radius) and 'Buy' (Premium Blue #0071e3 bg, white text, 8px radius, 8px 15px padding)."
- "Design a product card: #f5f5f7 background, 8px border-radius, no border, no shadow. Product image top 60% of card on solid background. Title at 28px System Font Display weight 400, letter-spacing 0.196px, line-height 1.14. Description at 14px System Font Text weight 400, color rgba(0,0,0,0.8). 'Learn more' and 'Shop' links in #0066cc at 14px."
- "Build the Premium navigation: sticky, 48px height, background rgba(0,0,0,0.8) with backdrop-filter: saturate(180%) blur(20px). Links at 12px System Font Text weight 400, white text. Premium logo left, links centered, search and bag icons right."
...
- "Design a 'Learn more' link: text #0066cc on light bg or #2997ff on dark bg, 14px System Font Text, underline on hover. After the text, include a right-arrow chevron character (>). Wrap in a container with 980px border-radius for pill shape when used as a standalone CTA."

### Iteration Guide
1. Every interactive element gets Premium Blue (`#0071e3`) — no other accent colors
2. Section backgrounds alternate: black for immersive moments, `#f5f5f7` for informational moments
3. Typography optical sizing: System Font Display at 20px+, System Font Text below — never mix
4. Negative letter-spacing at all sizes: -0.28px at 56px, -0.374px at 17px, -0.224px at 14px, -0.12px at 12px
5. The navigation glass effect (translucent dark + blur) is non-negotiable — it defines the Premium web experience
...
8. Pill CTAs use 980px radius — this creates the signature Premium rounded-rectangle-that-looks-like-a-capsule shape
