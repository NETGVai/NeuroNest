...
What makes Cinema distinctive is its complete commitment to visual content as design. Rather than illustrating features with icons or diagrams, Cinema shows actual AI-generated and AI-enhanced imagery — cars driving through cinematic landscapes, artistic portraits, architectural renders. The interface itself retreats into near-invisibility: minimal borders, zero shadows, subtle cool-gray text, and a dark palette that puts maximum focus on the photography.
...
### Primary
- **Cinema Black** (`#000000`): The primary page background and maximum-emphasis text.
...
- Logo: Cinema wordmark in white/black
...
- **Images replace whitespace**: Where other sites use empty space, Cinema fills it with photography. The visual content IS the breathing room.
...
- Don't use pill-shaped radius — Cinema's geometry is subtly rounded, not circular
...
- Background Dark: "Cinema Black (#000000)"
...
- "Design a mission statement section: Cinema Black background, white text at 36px abcNormal, line-height 1.0, letter-spacing -0.9px. Centered, with generous vertical padding."
