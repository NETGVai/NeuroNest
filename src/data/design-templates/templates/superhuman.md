...
### Semantic & Accent
- Premium operates with extreme color restraint — Lavender Glow (`#cbb7fb`) is the only true accent
...
### Inputs & Forms
- Minimal form presence on the marketing site — Premium funnels users directly to signup
...
- "Your Premium suite" section with product feature grid
...
- **Feature grid**: Even column distribution for "Your Premium suite" product showcase
...
### Shadow Philosophy
Premium's elevation system is remarkably restrained on the marketing site. Depth is primarily communicated through:
...
### Don't
- Use conventional font weights (400, 500, 600) — Premium's 460 and 540 are deliberately between standard stops
...
- Add decorative elements, icons, or illustrations — Premium relies on product UI and minimal typography
