# Design System: Data Canvas

## 1. Visual Theme & Atmosphere

Data Canvas's website is a clean, enterprise-friendly platform that communicates "sophisticated simplicity" through a white canvas with deep navy text (`#181d26`) and Data Canvas Blue (`#1b61c9`) as the primary interactive accent. The Haas font family (display + text variants) creates a Swiss-precision typography system with positive letter-spacing throughout.

**Key Characteristics:**
- White canvas with deep navy text (`#181d26`)
- Data Canvas Blue (`#1b61c9`) as primary CTA and link color
...
- **Data Canvas Blue** (`#1b61c9`): CTA buttons, links
...
## 7. Do's and Don'ts
### Do: Use Data Canvas Blue for CTAs, Haas with positive tracking, 12px radius buttons
