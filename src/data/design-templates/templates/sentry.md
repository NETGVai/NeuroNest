...
### Accent Colors
- **Monitor Purple** (`#6a5fc1`): Primary interactive color — links, hover states, focus rings
...
- **Hover**: color transitions to `#6a5fc1` (Monitor Purple)
...
- White text, hover to Monitor Purple (`#6a5fc1`)
