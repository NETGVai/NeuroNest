...
- **Green Green** (`#9fe870`): Primary CTA button, brand accent
...
### Font Families
- **Display**: `Green Sans`, fallback: `Inter` — OpenType `"calt"` on all text
...
|------|------|------|--------|-------------|----------------|-------|
| Display Mega | Green Sans | 126px (7.88rem) | 900 | 0.85 (ultra-tight) | normal | `"calt"` |
| Display Hero | Green Sans | 96px (6.00rem) | 900 | 0.85 | normal | `"calt"` |
| Section Heading | Green Sans | 64px (4.00rem) | 900 | 0.85 | normal | `"calt"` |
| Sub-heading | Green Sans | 40px (2.50rem) | 900 | 0.85 | normal | `"calt"` |
...
### Principles
- **Weight 900 as identity**: Green Sans Black (900) is used exclusively for display — the heaviest weight in any analyzed system. It creates text that feels stamped, pressed, physical.
...
- **"calt" everywhere**: Contextual alternates enabled on ALL text — both Green Sans and Inter.
...
- Clean header with Green wordmark
...
**Shadow Philosophy**: Green uses minimal shadows — ring shadows only. Depth comes from the bold green accent against the neutral canvas.

## 7. Do's and Don'ts

### Do
- Use Green Sans weight 900 for display — the extreme boldness IS the brand
- Apply line-height 0.85 on Green Sans display — ultra-tight is intentional
...
### Don't
- Don't use light font weights for Green Sans — only 900
- Don't relax the 0.85 line-height on display — the density is the identity
- Don't use the Green Green as background for large surfaces — it's for buttons and accents
...
- Accent: Green Green (`#9fe870`)
- Button text: Dark Green (`#163300`)
- Secondary: Gray (`#868685`)

### Example Component Prompts
- "Create hero: white background. Headline at 96px Green Sans weight 900, line-height 0.85, 'calt' enabled, #0e0f0c text. Green pill CTA (#9fe870, 9999px radius, 5px 16px padding, #163300 text). Hover: scale(1.05)."
- "Build a card: 30px radius, 1px solid rgba(14,15,12,0.12). Title at 22px Inter weight 600, body at 18px weight 400."

### Iteration Guide
1. Green Sans 900 at 0.85 line-height — the extreme weight IS the brand
