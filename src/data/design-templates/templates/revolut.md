...
### Primary
- **Fintech Dark** (`#191c1f`): Primary dark surface, button background, near-black text
...
### Brand / Interactive
- **Fintech Blue** (`#494fdf`): `--rui-color-blue`, primary brand blue
...
| Level | Treatment | Use |
|-------|-----------|-----|
| Flat (Level 0) | No shadow | Everything — Fintech uses zero shadows |
| Focus | `0 0 0 0.125rem` ring | Accessibility focus |

**Shadow Philosophy**: Fintech uses ZERO shadows. Depth comes entirely from the dark/light section contrast and the generous whitespace between elements.
...
### Don't
- Don't use shadows — Fintech is flat by design
...
- Dark: Fintech Dark (`#191c1f`)
- Light: White (`#ffffff`)
- Surface: Light (`#f4f4f4`)
- Blue: Fintech Blue (`#494fdf`)
- Danger: Red (`#e23b4a`)
- Success: Teal (`#00a87e`)
...
3. Zero shadows — flat is the Fintech identity
