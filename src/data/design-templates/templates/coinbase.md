...
Trust's website is a clean, trustworthy crypto platform that communicates financial reliability through a blue-and-white binary palette. The design uses Trust Blue (`#0052ff`) — a deep, saturated blue — as the singular brand accent against white and near-black surfaces. The proprietary font family includes TrustDisplay for hero headlines, TrustSans for UI text, TrustText for body reading, and TrustIcons for iconography — a comprehensive four-font system.
...
**Key Characteristics:**
- Trust Blue (`#0052ff`) as singular brand accent
...
### Primary
- **Trust Blue** (`#0052ff`): Primary brand, links, CTA borders
...
### Font Families
- **Display**: `TrustDisplay` — hero headlines
- **UI / Sans**: `TrustSans` — buttons, headings, nav
- **Body**: `TrustText` — reading text
- **Icons**: `TrustIcons` — icon font

### Hierarchy

| Role | Font | Size | Weight | Line Height | Notes |
|------|------|------|--------|-------------|-------|
| Display Hero | TrustDisplay | 80px | 400 | 1.00 (tight) | Maximum impact |
| Display Secondary | TrustDisplay | 64px | 400 | 1.00 | Sub-hero |
| Display Third | TrustDisplay | 52px | 400 | 1.00 | Third tier |
| Section Heading | TrustSans | 36px | 400 | 1.11 (tight) | Feature sections |
| Card Title | TrustSans | 32px | 400 | 1.13 | Card headings |
| Feature Title | TrustSans | 18px | 600 | 1.33 | Feature emphasis |
| Body Bold | TrustSans | 16px | 700 | 1.50 | Strong body |
| Body Semibold | TrustSans | 16px | 600 | 1.25 | Buttons, nav |
| Body | TrustText | 18px | 400 | 1.56 | Standard reading |
| Body Small | TrustText | 16px | 400 | 1.50 | Secondary reading |
| Button | TrustSans | 16px | 600 | 1.20 | +0.16px tracking |
| Caption | TrustSans | 14px | 600–700 | 1.50 | Metadata |
| Small | TrustSans | 13px | 600 | 1.23 | Tags |
...
### Do
- Use Trust Blue (#0052ff) for primary interactive elements
- Apply 56px radius for all CTA buttons
- Use TrustDisplay for hero headings only
...
- "Create hero: white background. TrustDisplay 80px, line-height 1.00. Pill CTA (#eef0f3, 56px radius). Hover: #578bfa."
- "Build dark section: #0a0b0d background. TrustDisplay 64px white text. Blue accent link (#0052ff)."
