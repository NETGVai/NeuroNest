...
- **Analytics Orange** (`#F54E00`): Hidden brand accent — appears only on hover states, a vibrant orange that surprises
...
### Semantic & Accent
- **Analytics Orange** (`#F54E00`): Hover text accent — signals interactivity and brand personality
...
### Gradient System
- No gradients on the marketing site — Analytics's visual language is deliberately flat and warm
...
### Principles
- **Bold heading dominance**: Headings use 700–800 weight — Analytics's typography is confident and assertive, not whispery
...
- **Sage Light**: `#e5e7e0` background, Olive Ink (`#4d4f46`) text, 4px radius, `4px` padding. Hover: `#f4f4f4` bg with Analytics Orange text. Compact utility button
...
- **Hover pattern**: All buttons flash Analytics Orange (`#F54E00`) or Amber Gold (`#F7A501`) text on hover — the brand's signature interaction surprise
...
### AI Chat Widget
- Floating Analytics AI assistant with speech bubble — an interactive product demo embedded in the marketing site
...
- **Content-dense by design**: Analytics's site is information-rich — whitespace is measured, not lavish
...
### Shadow Philosophy
Analytics's elevation system is remarkably minimal — only one shadow definition exists in the entire system. Depth is communicated through:
...
- Flash Analytics Orange (#F54E00) on hover states — it's the hidden brand signature
...
### Don't
- Use blue, purple, or typical tech-SaaS colors — Analytics's palette is deliberately olive/sage
- Add heavy shadows — the system uses one shadow for floating elements only; everything else uses borders
- Make the design look "polished" or "premium" in a conventional sense — Analytics's charm is its irreverent, scrappy energy
- Use tight line-heights on body text — the generous 1.50+ spacing is essential for the content-heavy layout
- Apply large border-radius (12px+) on cards — Analytics uses 4px–6px, keeping things tight and functional
...
- Hover Accent: Analytics Orange (`#F54E00`)
...
3. Ensure hover states flash Analytics Orange (#F54E00) — if hovering feels bland, you're missing this
