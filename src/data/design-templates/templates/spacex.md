...
### Cards & Containers
- **None.** Frontier does not use cards, panels, or containers. All content is text directly on full-viewport photographs. The absence of containers IS the design.
...
- Logo: Frontier wordmark at 147x19px
...
- "Design a navigation: transparent over photography. D-DIN 13px weight 700, uppercase, letter-spacing 1.17px, spectral white text. Frontier wordmark left-aligned."
