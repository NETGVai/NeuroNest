...
- The Terminal llama as the sole illustration — black line art, no color
...
### Gradient System
- **None.** Terminal uses absolutely no gradients. Visual separation comes from flat color blocks and single-pixel borders. This is a deliberate, almost philosophical design choice.

## 3. Typography Rules

### Font Family
- **Display**: `System Font Rounded`, with fallbacks: `system-ui, -apple-system, system-ui`
- **Body / UI**: `ui-sans-serif`, with fallbacks: `system-ui, Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji`
- **Monospace**: `ui-monospace`, with fallbacks: `SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New`

*Note: System Font Rounded is the platform's system font — it renders with rounded terminals on macOS/iOS and falls back to the system sans-serif on other platforms.*

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | System Font Rounded | 48px (3rem) | 500 | 1.00 (tight) | normal | Maximum impact, rounded letterforms |
| Section Heading | System Font Rounded | 36px (2.25rem) | 500 | 1.11 (tight) | normal | Feature section titles |
| Sub-heading | System Font Rounded / ui-sans-serif | 30px (1.88rem) | 400–500 | 1.20 (tight) | normal | Card headings, feature names |
...
### Principles
- **Rounded display, standard body**: System Font Rounded carries display headlines with its distinctive rounded terminals, while the standard system sans handles all body text. The rounded font IS the brand expression.
...
- Logo: Terminal llama icon + wordmark in black
...
### Image Treatment
- The Terminal llama mascot is the only illustration — black line art on white
...
**Integration Grid**
- Grid of integration logos (Codex, AI assistant, OpenCode, LangChain, etc.)
...
- **Content density is low by design**: Where other AI companies pack feature after feature, Terminal presents three ideas (run models, use with apps, integrations) and stops.
...
- Use System Font Rounded at weight 500 for display headings — the rounded terminals are the brand expression
...
- "Create a hero section on pure white (#ffffff) with an illustration centered above a headline at 48px System Font Rounded weight 500, line-height 1.0. Use Pure Black (#000000) text. Below, add a black pill-shaped CTA button (9999px radius, 10px 24px padding) and a gray pill button."
...
- "Design a navigation bar: transparent background, no border. Terminal logo on the left, 3 text links (Pure Black, 16px, weight 400), pill search input in the center, 'Sign in' text link and black pill 'Download' button on the right."
...
6. If something feels too decorated, remove it — less is always more for Terminal
