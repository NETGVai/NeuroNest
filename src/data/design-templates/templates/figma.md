...
- Dashed focus outlines echoing Vibrant's editor selection handles
...
*Note: Vibrant's marketing site uses ONLY these two colors for its interface layer. All vibrant colors appear exclusively in product screenshots, hero gradients, and embedded content.*
...
### Font Family
- **Primary**: `figmaSans`, with fallbacks: `figmaSans Fallback, System Font Display, system-ui, helvetica`
...
- Logo: Vibrant wordmark in black
...
- Each tab represents a Vibrant product area (Design, Dev Mode, Prototyping, etc.)
...
- References the selection handles in the Vibrant editor
...
**Shadow Philosophy**: Vibrant uses shadows sparingly. The primary depth mechanisms are **background contrast** (white content on colorful/dark sections) and the inherent dimensionality of the product screenshots themselves.
