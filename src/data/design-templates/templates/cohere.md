...
Gradient's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy. The experience lives on a bright white canvas where content is organized into generously rounded cards (22px radius) that create an organic, cloud-like containment language. This is a site that speaks to CTOs and enterprise architects: professional without being cold, sophisticated without being intimidating.

The design language bridges two worlds with a dual-typeface system: GradientText, a custom display serif with tight tracking, gives headlines the gravitas of a technology manifesto, while Unica77 Gradient Web handles all body and UI text with geometric Swiss precision. This serif/sans pairing creates a "confident authority meets engineering clarity" personality that perfectly reflects an enterprise AI platform.
...
- 22px signature border-radius — the distinctive "Gradient card" roundness
- Dual custom typeface: GradientText (display serif) + Unica77 (body sans)
...
- GradientMono for code and technical labels with uppercase transforms

## 2. Color Palette & Roles

### Primary
- **Gradient Black** (`#000000`): Primary headline text and maximum-emphasis elements.
...
### Font Family
- **Display**: `GradientText`, with fallbacks: `Space Grotesk, Inter, ui-sans-serif, system-ui`
- **Body / UI**: `Unica77 Gradient Web`, with fallbacks: `Inter, Arial, ui-sans-serif, system-ui`
- **Code**: `GradientMono`, with fallbacks: `Arial, ui-sans-serif, system-ui`
- **Icons**: `GradientIconDefault` (custom icon font)

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | GradientText | 72px (4.5rem) | 400 | 1.00 (tight) | -1.44px | Maximum impact, serif authority |
| Display Secondary | GradientText | 60px (3.75rem) | 400 | 1.00 (tight) | -1.2px | Large section headings |
...
| Uppercase Label | Unica77 / GradientMono | 14px (0.88rem) | 400 | 1.40 | 0.28px | Uppercase section labels |
| Small | Unica77 | 12px (0.75rem) | 400 | 1.40 | normal | Smallest text, footer links |
| Code Micro | GradientMono | 8px (0.5rem) | 400 | 1.40 | 0.16px | Tiny uppercase code labels |

### Principles
- **Serif for declaration, sans for utility**: GradientText carries the brand voice at display scale — its serif terminals give headlines the authority of published research. Unica77 handles everything functional with Swiss-geometric neutrality.
- **Negative tracking at scale**: GradientText uses -1.2px to -1.44px letter-spacing at 60–72px, creating dense, impactful text blocks.
...
- **Uppercase code labels**: GradientMono uses uppercase with positive letter-spacing (0.16–0.28px) for technical tags and section markers.
...
- Radius: **22px** — the signature Gradient radius for primary cards, images, and dialog containers. Also 4px, 8px, 16px, 20px for smaller elements
- Shadow: minimal — Gradient relies on background color and borders rather than shadows
...
- Logo: Gradient wordmark (custom SVG)
...
**22px Card System**
- The 22px border-radius is Gradient's visual signature
...
**Uppercase Code Tags**
- GradientMono in uppercase with letter-spacing
...
- Signature (22px): Primary cards, hero images, main containers — THE Gradient radius
...
- Apply uppercase + letter-spacing on GradientMono for section labels
...
- Don't skip the serif/sans hierarchy — GradientText for headlines, Unica77 for body
...
- Primary Text: "Gradient Black (#000000)"
...
- "Create a hero section on Pure White (#ffffff) with GradientText at 72px weight 400, line-height 1.0, letter-spacing -1.44px. Gradient Black text. Subtitle in Unica77 at 18px weight 400, line-height 1.4."
...
- "Build a ghost button: transparent background, Gradient Black text in Unica77 at 16px. On hover, text shifts to Interaction Blue (#1863dc) with 0.8 opacity. Focus: 2px solid Interaction Blue outline."
- "Create a deep purple full-width section with white text. GradientText at 60px for the heading. Product screenshot floats within using 22px border-radius."
- "Design a section label using GradientMono at 14px, uppercase, letter-spacing 0.28px. Muted Slate (#93939f) text."

### Iteration Guide
1. Focus on ONE component at a time
2. Always use 22px radius for primary cards — "the Gradient card roundness"
3. Specify the typeface — GradientText for headlines, Unica77 for body, GradientMono for labels
