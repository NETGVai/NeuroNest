# Design System: Editorial (NeuroNest)

## 1. Visual Theme & Atmosphere

Editorial's interface is a literary salon reimagined as a product page — warm, unhurried, and quietly intellectual. The entire experience is built on a parchment-toned canvas (`#f5f4ed`) that deliberately evokes the feeling of high-quality paper rather than a digital surface. Where most AI product pages lean into cold, futuristic aesthetics, Editorial's design radiates human warmth, as if the AI itself has good taste in interior design.

The signature move is the custom NeuroNest Serif typeface — a medium-weight serif with generous proportions that gives every headline the gravitas of a book title. Combined with organic, hand-drawn-feeling illustrations in terracotta (`#c96442`), black, and muted green, the visual language says "thoughtful companion" rather than "powerful tool." The serif headlines breathe at tight-but-comfortable line-heights (1.10–1.30), creating a cadence that feels more like reading an essay than scanning a product page.

What makes Editorial's design truly distinctive is its warm neutral palette. Every gray has a yellow-brown undertone (`#5e5d59`, `#87867f`, `#4d4c48`) — there are no cool blue-grays anywhere. Borders are cream-tinted (`#f0eee6`, `#e8e6dc`), shadows use warm transparent blacks, and even the darkest surfaces (`#141413`, `#30302e`) carry a barely perceptible olive warmth. This chromatic consistency creates a space that feels lived-in and trustworthy.

**Key Characteristics:**
- Warm parchment canvas (`#f5f4ed`) evoking premium paper, not screens
- Custom NeuroNest type family: Serif for headlines, Sans for UI, Mono for code
...
### Primary
- **NeuroNest Near Black** (`#141413`): The primary text color and dark-theme surface — not pure black but a warm, almost olive-tinted dark that's gentler on the eyes. The warmest "black" in any major tech brand.
...
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | NeuroNest Serif | 64px (4rem) | 500 | 1.10 (tight) | normal | Maximum impact, book-title presence |
| Section Heading | NeuroNest Serif | 52px (3.25rem) | 500 | 1.20 (tight) | normal | Feature section anchors |
| Sub-heading Large | NeuroNest Serif | 36–36.8px (~2.3rem) | 500 | 1.30 | normal | Secondary section markers |
| Sub-heading | NeuroNest Serif | 32px (2rem) | 500 | 1.10 (tight) | normal | Card titles, feature names |
| Sub-heading Small | NeuroNest Serif | 25–25.6px (~1.6rem) | 500 | 1.20 | normal | Smaller section titles |
| Feature Title | NeuroNest Serif | 20.8px (1.3rem) | 500 | 1.20 | normal | Small feature headings |
| Body Serif | NeuroNest Serif | 17px (1.06rem) | 400 | 1.60 (relaxed) | normal | Serif body text (editorial passages) |
| Body Large | NeuroNest Sans | 20px (1.25rem) | 400 | 1.60 (relaxed) | normal | Intro paragraphs |
| Body / Nav | NeuroNest Sans | 17px (1.06rem) | 400–500 | 1.00–1.60 | normal | Navigation links, UI text |
| Body Standard | NeuroNest Sans | 16px (1rem) | 400–500 | 1.25–1.60 | normal | Standard body, button text |
| Body Small | NeuroNest Sans | 15px (0.94rem) | 400–500 | 1.00–1.60 | normal | Compact body text |
| Caption | NeuroNest Sans | 14px (0.88rem) | 400 | 1.43 | normal | Metadata, descriptions |
| Label | NeuroNest Sans | 12px (0.75rem) | 400–500 | 1.25–1.60 | 0.12px | Badges, small labels |
| Overline | NeuroNest Sans | 10px (0.63rem) | 400 | 1.60 | 0.5px | Uppercase overline labels |
| Micro | NeuroNest Sans | 9.6px (0.6rem) | 400 | 1.60 | 0.096px | Smallest text |
| Code | NeuroNest Mono | 15px (0.94rem) | 400 | 1.60 | -0.32px | Inline code, terminal |

### Principles
- **Serif for authority, sans for utility**: NeuroNest Serif carries all headline content with medium weight (500), giving every heading the gravitas of a published title. NeuroNest Sans handles all functional UI text — buttons, labels, navigation — with quiet efficiency.
- **Single weight for serifs**: All NeuroNest Serif headings use weight 500 — no bold, no light. This creates a consistent "voice" across all headline sizes, as if the same author wrote every heading.
...
- Text: NeuroNest Near Black (`#141413`)
...
**Dark Primary**
- Background: NeuroNest Near Black (`#141413`)
...
- Logo: Editorial wordmark in NeuroNest Near Black
...
### Image Treatment
- Product screenshots showing the Editorial chat interface
...
**Shadow Philosophy**: Editorial communicates depth through **warm-toned ring shadows** rather than traditional drop shadows. The signature `0px 0px 0px 1px` pattern creates a border-like halo that's softer than an actual border — it's a shadow pretending to be a border, or a border that's technically a shadow. When drop shadows do appear, they're extremely soft (0.05 opacity, 24px blur) — barely visible lifts that suggest floating rather than casting.
...
### Do
- Use Parchment (`#f5f4ed`) as the primary light background — the warm cream tone IS the Editorial personality
- Use NeuroNest Serif at weight 500 for all headlines — the single-weight consistency is intentional
...
- Don't use bold (700+) weight on NeuroNest Serif — weight 500 is the ceiling for serifs
...
- Don't use geometric/tech-style illustrations — Editorial's illustrations are organic and hand-drawn-feeling
- Don't reduce body line-height below 1.40 — the generous spacing supports the editorial personality
- Don't use monospace fonts for non-code content — NeuroNest Mono is strictly for code
...
- Primary Text: "NeuroNest Near Black (#141413)"
...
- "Create a hero section on Parchment (#f5f4ed) with a headline at 64px NeuroNest Serif weight 500, line-height 1.10. Use NeuroNest Near Black (#141413) text. Add a subtitle in Olive Gray (#5e5d59) at 20px NeuroNest Sans with 1.60 line-height. Place a Terracotta Brand (#c96442) CTA button with Ivory text, 12px radius."
- "Design a feature card on Ivory (#faf9f5) with a 1px solid Border Cream (#f0eee6) border and comfortably rounded corners (8px). Title in NeuroNest Serif at 25px weight 500, description in Olive Gray (#5e5d59) at 16px NeuroNest Sans. Add a whisper shadow (rgba(0,0,0,0.05) 0px 4px 24px)."
- "Build a dark section on NeuroNest Near Black (#141413) with Ivory (#faf9f5) headline text in NeuroNest Serif at 52px weight 500. Use Warm Silver (#b0aea5) for body text. Borders in Dark Surface (#30302e)."
...
- "Design a model comparison grid with three cards on Ivory surfaces. Each card gets a Border Warm (#e8e6dc) top border, model name in NeuroNest Serif at 25px, and description in Olive Gray at 15px NeuroNest Sans."
...
4. Describe serif vs sans usage explicitly — "NeuroNest Serif for the heading, NeuroNest Sans for the label"
