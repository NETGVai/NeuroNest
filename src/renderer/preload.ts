...
const INVOKE_CHANNELS = [
  ...
  'get-config', 'get-commands', 'save-providers', 'load-providers', 'get-agent-model', 'validate-api-key', 'list-provider-models', 'get-ollama-status', 'install-ollama', 'start-ollama', 'stop-ollama', 'start-llamacpp', 'stop-llamacpp', 'uninstall-ollama', 'uninstall-llamacpp', 'pull-ollama-model', 'set-default-provider', 'get-default-provider', 'get-execution-mode', 'set-execution-mode', 'get-project-files', 'read-project-file', 'get-dashboard-stats', 'get-system-stats', 'get-system-stats-slow', 'get-integrations', 'get-channel-configs', 'connect-channel', 'disconnect-channel', 'send-channel-message', 'get-channel-status', 'get-llamacpp-status', 'install-llamacpp', 'get-agent-prompt', 'get-departments', 'autocomplete-command', 'download-project-zip', 'webauthn-register-start', 'webauthn-register-finish', 'webauthn-login-start', 'webauthn-login-finish',
