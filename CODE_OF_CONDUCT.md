# NeuroNest Code of Conduct

## Our Commitment

NeuroNest is built by people who care about shipping great software, and we want the community around it to reflect that same care. We are committed to making participation in this project a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
- Helping newcomers get oriented — whether in the codebase, the agent architecture, or the contribution process
...
- Submitting deliberately malicious code, prompt-injection payloads, or security exploits disguised as contributions
- Other conduct which could reasonably be considered inappropriate in a professional setting

## Scope

This Code of Conduct applies within all community spaces — the GitHub repository (issues, pull requests, discussions), and any official NeuroNest channels — and also applies when an individual is officially representing the community in public spaces.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers at **conduct@netgv.ai**. All complaints will be reviewed and investigated promptly and fairly. All maintainers are obligated to respect the privacy and security of the reporter of any incident.
